...
export const STAGES: StageDef[] = [
  {
    ...
    duration: 90,
    pool: ['slime', 'bat', 'skeleton', 'mushroom'],
  ...
  },
  {
    ...
    duration: 110,
    pool: ['slime', 'bat', 'skeleton', 'runner', 'spider', 'bigSlime', 'mushroom', 'golem'],
  ...
  },
  {
    ...
    duration: 130,
    pool: ['bat', 'skeleton', 'runner', 'spider', 'ghost', 'caster', 'brute', 'demon', 'witch'],
  ...
  },
  {
    ...
    duration: 150,
    pool: ['runner', 'spider', 'ghost', 'caster', 'brute', 'bigSlime', 'skeleton', 'demon', 'witch', 'golem'],
