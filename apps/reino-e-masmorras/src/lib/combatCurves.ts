...
// Long dungeons already compound enemy pressure across twelve persistent-HP
// encounters. Attack therefore grows at the square root of the dungeon CP
// anchor while HP remains linear and DEF remains at 0.62. This preserves
// fight duration and late-game toughness without multiplying attrition twice.
export function atkDifficultyMultiplier(difficulty: number): number { return Math.pow(Math.max(0.01, difficulty), 0.50); }
