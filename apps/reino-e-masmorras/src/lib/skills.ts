...
SKILL_TREES.necromante = [
  buildPath('necromante', 'decomposicao', 'Decomposição', '#3a3a4a', [
    ...
    { name: 'Praga Necrótica', desc: 'Cause 1,10x MATK, aplique 2 Decomposições e uma Praga de 0,16x MATK por 4 ciclos.', ability: { name: 'Praga Necrótica', desc: '1,10x MATK, +2 Decomposições e Praga Necrótica.', cooldown: 4, condition: { type: 'always' }, effect: { kind: 'bigHit', dmgMult: 1.10, dmgType: 'magical', decompositionOnHit: 2, plagueApply: true, plagueMultiplier: 0.16, plagueDuration: 4, necromancerTag: 'decomposition' } }, mechanicRefs: ['necromante:decomposition', 'necromante:plague'], scaling: necroInt('A Praga guarda o MATK atual e Decomposição fortalece cada tick.') },
