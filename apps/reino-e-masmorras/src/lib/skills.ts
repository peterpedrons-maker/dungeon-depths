...
SKILL_TREES.druida = [
  buildPath('druida', 'cura-natural', 'Renascimento', '#3f8a5a', [
    { name: 'Raiz Profunda', desc: '+8 Vida Máxima.', effect: { maxHpFlat: 8 },
    ...
    { name: 'Casca Fresca', desc: '+2% de defesa.', effect: { defPct: 0.02 },
      mechanicRefs: ['druida:garden'] },
    { name: 'Ritmo da Seiva', desc: '-3% de recarga somente para habilidades de Renascimento.', effect: {} },
    { name: 'Semeadura Vital', desc: 'Habilidade ativa: cura direta de 6% da Vida Base. Depois, planta 1 Semente no Jardim (2 se Sintonizada). Recarga de 4 ciclos.',
      mechanicRefs: ['druida:season', 'druida:garden'],
      ability: { name: 'Semeadura Vital', desc: 'Cura 6% da Vida Base; depois planta 1 Semente (2 se Sintonizada). Primavera.',
        cooldown: 4, condition: { type: 'always' },
        effect: { kind: 'heal', healPct: 0.06, druidSeason: 'spring', druidPath: 'rebirth', druidPlantSeeds: 1, druidPlantSeedsAligned: 2 } },
    ...
    { name: 'Colheita Ancestral', desc: 'Habilidade ativa: causa 1,10x de MATK (1,25x se Sintonizada). Depois, consome Frutos disponíveis um por um enquanto houver HP faltando (7%/8% da Vida Base cada). Recarga de 4 ciclos.',
      mechanicRefs: ['druida:season', 'druida:garden'],
      ability: { name: 'Colheita Ancestral', desc: '1,10x MATK; depois consome Frutos até restaurar a Vida Máxima ou esgotar o Jardim. Outono: 1,25x e 8% por Fruto.',
        cooldown: 4, condition: { type: 'always' },
        effect: { kind: 'bigHit', dmgMult: 1.10, dmgMultAligned: 1.25, druidSeason: 'autumn', druidPath: 'rebirth', druidHarvest: true, druidHarvestHealPctPerFruit: 0.07, druidHarvestHealPctPerFruitAligned: 0.08 } },
    ...
    { name: 'Árvore Ancestral', desc: 'Habilidade ativa (cycle, requer Renovo): consome o Renovo, cura 8% da Vida Base, transforma todo o Jardim em Fruto e abre a Copa Ancestral por 4 ações (Frutos curam +25%; o primeiro Fruto consumido nessa janela não é removido). Recarga de 9 ciclos.',
      mechanicRefs: ['druida:renewal', 'druida:garden'],
      ability: { name: 'Árvore Ancestral', desc: 'Consome Renovo. Cura 8% da Vida Base, amadurece todo o Jardim em Fruto e abre a Copa Ancestral (4 ações, Frutos +25% de cura).',
        cooldown: 9, condition: { type: 'resourceAtLeast', resource: 'renewal', value: 1 },
        effect: { kind: 'heal', healPct: 0.08, druidSeason: 'cycle', druidPath: 'rebirth', druidTreeOfLife: true } },
  ...
  buildPath('druida', 'furia-natureza', 'Metamorfose', '#8a3a2a', [
    ...
    { name: 'Pele Ancestral', desc: '+8 Vida Máxima. Enquanto qualquer Forma estiver ativa, +2% de defesa mágica.', effect: { maxHpFlat: 8 },
      mechanicRefs: ['druida:form'] },
    ...
    { name: 'Ritmo Mutável', desc: '-3% de recarga somente para habilidades de Metamorfose.', effect: {} },
  ...
  buildPath('druida', 'equilibrio', 'Equilíbrio', '#4f7a3a', [
    ...
    { name: 'Corpo de Carvalho', desc: '+8 Vida Máxima. Com Descompasso 2 ou mais, +2% de defesa.', effect: { maxHpFlat: 8 },
      mechanicRefs: ['druida:dissonance'] },
    { name: 'Compasso Natural', desc: '-3% de recarga somente para habilidades de Equilíbrio.', effect: {} },
