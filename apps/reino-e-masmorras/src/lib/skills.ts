...
export const SKILL_TREES: Record<ClassId, SkillPath[]> = {
  ...
  clerigo: [
    buildPath('clerigo', 'devocao', 'Devoção', '#d8c27a', [
      ...
      { name: 'Ressurreição Menor', desc: 'Habilidade ativa: recupera 55% da vida máxima. Recarga de 11s.',
        ability: { name: 'Ressurreição Menor', desc: 'Recupera 55% da vida máxima.', cooldown: 7, condition: { type: 'always' }, effect: { kind: 'heal', healPct: 0.55 } } },
