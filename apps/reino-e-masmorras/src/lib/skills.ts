...
export const SKILL_TREES: Record<ClassId, SkillPath[]> = {
  ...
  clerigo: [
    ...
    buildPath('clerigo', 'provacao', 'Provação', '#8a4a6b', [
      ...
      { name: 'Purificação Divina', desc: 'Habilidade ativa: remove todos os efeitos negativos ativos em você — só entra na prioridade quando há algo pra remover. Recarga de 5 rodadas.',
  ...
  bardo: [
    ...
    buildPath('bardo', 'melodia-sombria', 'Melodia Sombria', '#4a2a5a', [
      ...
      { name: 'Nota Dissonante', desc: 'Habilidade ativa: remove todos os efeitos negativos ativos em você — só entra na prioridade quando há algo pra remover. Recarga de 5 rodadas.',
