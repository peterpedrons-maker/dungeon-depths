...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { id: 'base-hp', title: 'Vida Base', aliases: ['Vida Base'], shortDescription: 'Vida definida apenas pela classe e pelo nível.', fullDescription: 'Vida Base não inclui VIT, equipamento, talentos ou bônus temporários. Algumas curas usam esse valor para manter o balanceamento previsível.' },
