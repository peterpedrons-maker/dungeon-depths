...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { id: 'cooldown', title: 'Recarga', aliases: ['Recarga', 'recarga'], shortDescription: 'Segundos necessários para usar a habilidade novamente.', fullDescription: 'A Recarga começa quando a habilidade é usada e pode ser reduzida por efeitos de redução de recarga.' },
