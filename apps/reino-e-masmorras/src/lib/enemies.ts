...
// matk/mdef scale roughly with each shape's physical atk/def; only the two
// spellcasting shapes (Aberração, Dragão) actually roll their attacks as
// magical (atkType: 'magical') — everyone else's mdef just sits there ready
// for the day the player's own spells hit them.
const TIERS: EnemyTier[] = [
  ...
  { shape: 'skeleton', name: 'Esqueleto',            color: '#d8d2b8', minDepth: 5,  hp: 23, atk: 7,  def: 3,  xp: 13, gold: 9,  matk: 3,  mdef: 2,
