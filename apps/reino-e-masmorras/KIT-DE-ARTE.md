...
Row 1 ("Piromante" path — every medallion's rim and inner glow painted in a burnt fire-orange/red, #c1502e): 1) "Queimadura" — a wand tip igniting a small enemy silhouette into orange flame. 2) "Névoa Onírica" — a swirling lavender dream-mist with small drooping "Zzz" wisps and an impact spark. 3) "Chuva de Fogo" — a shower of small falling fireball streaks raining down. 4) "Detonação" — a burning enemy silhouette exploding outward in a fiery burst. 5) "Cataclismo Ardente" — a massive fire mushroom-cloud eruption filling the frame.
