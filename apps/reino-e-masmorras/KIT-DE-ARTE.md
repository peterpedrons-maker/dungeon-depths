...
> Substitui o prompt antigo — a classe foi redesenhada depois que esse prompt foi escrito: nem as trilhas ("Canção de Guerra"/"Melodia Sombria"/"Inspiração" genéricas) nem nenhum dos 15 nomes de habilidade batem com a árvore real de hoje (Marcha de Guerra `#c9663c` / Dissonância `#4a2a5a` / Improviso `#e0c060`). Reescrito do zero contra `skills.ts`, seguindo o método v5 aprovado (Feiticeiro/Bruxo/Druida): medalhão circular, arma só nos 2 ícones de abertura e 2 de finalização de cada trilha (6 no total, nunca na mesma pose), o resto é efeito musical puro, nenhuma composição repetida. Arma conferida contra `weapon-bardo.webp`: é alaúde (lute) em todas as 10 variações — os 6 ícones "com alaúde" abaixo usam esse instrumento, não um livro nem cajado.
...
IMPORTANT GLOBAL RULES: (1) This character's only weapon is a wooden lute (a rounded pear-shaped body, a fretted neck, and strings) — it appears ONLY in the six icons explicitly marked "(com alaúde)" below, always gripped or played by one visible hand of a partial bard figure (just a cloaked silhouette, one or both hands, and forearms — never a full character portrait), in a distinct dramatic pose each time, never the same pose twice. (2) Every other icon (marked "(efeito puro)") shows ONLY the pure musical/sound phenomenon itself — no hands, no lute, no bard silhouette anywhere in frame. (3) None of the fifteen icons may depict a flying projectile, arrow, bolt, or dart of any kind. (4) EVERY SINGLE ONE of the fifteen icons must be built around a completely different central object or scene — no two medallions anywhere on this sheet may share a similar composition, pose, or object arrangement.

Row 1 ("Marcha de Guerra" path — every medallion's rim and inner glow painted in a rust-orange, #c9663c; theme: a driving battle-march rhythm): 1) "Acorde de Impacto" (com alaúde) — a cloaked bard's silhouette gripping their lute in one hand, the other hand's fingers caught at the exact instant of striking a chord, three overlapping rust-orange sound-ring shapes bursting directly off the strings like a struck chord made visible. 2) "Marcha Implacável" (efeito puro) — two rust-orange shockwave rings expanding outward one just behind the other from a shared central point, like two heavy marching footsteps landing in rapid succession. 3) "Grito em Compasso" (efeito puro) — a single rust-orange sound-wave burst radiating outward, thin motion-streak lines trailing off its edges like a sudden burst of speed. 4) "Solo de Batalha" (efeito puro) — one large rust-orange blade-shaped burst of sound striking straight down at the exact instant of impact, jagged sound-edges cutting through the air. 5) "Concerto de Guerra" (com alaúde) — a cloaked bard's silhouette standing triumphant, lute raised high overhead in one hand, two overlapping bursts of sound (one rust-orange, one paler orange) erupting together from the raised instrument.

Row 2 ("Dissonância" path — every medallion's rim and inner glow painted in a dark violet, #4a2a5a; theme: broken rhythm and clashing notes): 6) "Nota Quebrada" (com alaúde) — a cloaked bard's silhouette, one hand plucking a single lute string at the exact instant it snaps, a jagged dark violet crack-shaped sound-wave spreading outward from the broken string. 7) "Trítono" (efeito puro) — two dark violet sound-wave rings colliding directly into each other, sharp jagged interference-lines crackling where their edges meet. 8) "Quebra de Compasso" (efeito puro) — three evenly-spaced rhythm tick-marks in a row, the middle one shattered into fragments, dark violet cracks radiating outward from the gap it left. 9) "Ressonância Partida" (efeito puro) — a single dark violet sound-wave ring caught at the exact instant it splits cleanly into two uneven jagged halves. 10) "Réquiem sem Palavras" (com alaúde) — a cloaked bard's silhouette with head bowed low, lute held loosely in one hand, four thin dark violet sound-ripples fading outward around them in a fan, each one fainter than the last.

Row 3 ("Improviso" path — every medallion's rim and inner glow painted in a light gold, #e0c060; theme: warm restorative melody): 11) "Balada Restauradora" (com alaúde) — a cloaked bard's silhouette cradling their lute close against their chest with one arm, a warm golden sound-wave radiating gently outward from the strings like a single long sustained note. 12) "Interlúdio" (efeito puro) — one golden musical note resolving a small tangled dark thread-knot directly beneath it, the knot visibly loosening and dissolving into light at the point of contact. 13) "Verso de Improviso" (efeito puro) — a single golden musical note striking sharply downward with a bright crit-starburst flashing at its tip. 14) "Hino da Segunda Respiração" (efeito puro) — one large golden musical note blooming open like flower petals unfurling, warm restorative light spilling outward from its open center. 15) "Bis!" (com alaúde) — a cloaked bard's silhouette taking a deep bow, lute held out to one side in one hand, a translucent golden echo-outline of the same bowing pose repeating just behind and slightly offset from them.
...
> Mesmo método v5/v2 da folha de Ativas acima: **nenhum ícone mostra o bardo nem o alaúde** — só o fenômeno musical puro, num estado mais contido/latente/permanente do que o auge das Ativas. Cada um dos 9 ícones usa um objeto central inteiramente diferente (regra fixa do kit) — nenhum reciclado nem dentro da mesma trilha.
...
Row 1 ("Marcha de Guerra" path — every medallion's rim and inner glow painted in a rust-orange, #c9663c): 1) "Batida Marcada" — a single accent-stress musical mark (a small ">" wedge shape) glowing steady rust-orange, floating alone in dark space with no other elements around it. 2) "Sem Perder o Ritmo" — a single broken drumstick, snapped cleanly in half, its splintered tip still glowing with a faint rust-orange ember of rhythm. 3) "O Palco é Meu" — a narrow cone of rust-orange spotlight shining down onto one small empty circle marked on a dark stage floor.

Row 2 ("Dissonância" path — every medallion's rim and inner glow painted in a dark violet, #4a2a5a): 4) "Eco Roubado" — a single musical note shape, half of it solid dark violet and half of it faint and ghostly-transparent, as though part of it had been stolen away. 5) "Contratempo Perfeito" — one accent mark tilted backward, offset out of alignment from a faint straight rhythm-line drawn beneath it, both glowing dark violet. 6) "O Som Depois do Som" — a solid dark violet musical note with a fainter, smaller afterimage-copy of the same note trailing just behind and below it, like a fading echo.

Row 3 ("Improviso" path — every medallion's rim and inner glow painted in a light gold, #e0c060): 7) "Verso Livre" — a single golden musical note with one corner shaped like a small jester's-cap point, marking it as a wildcard, floating alone in dark space. 8) "Ponte Musical" — a short glowing golden footbridge plank connecting two small floating musical-note platforms on either side, light traveling steadily along the span. 9) "O Espetáculo Continua" — a faint, translucent, ghost-outline musical note rendered almost entirely see-through, a single wisp of golden light trailing from its curled tail.
