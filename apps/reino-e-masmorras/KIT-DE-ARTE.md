...
**Direção obrigatória:** no jogo, o herói do jogador sempre fica do lado esquerdo da tela e o inimigo do lado direito — cada um precisa visualmente "olhar" para o outro. Por isso todo prompt de **herói/classe** abaixo exige olhar pra **DIREITA**, e todo prompt de **inimigo** exige olhar pra **ESQUERDA**. Se uma imagem gerada sair olhando pro lado errado (ou de frente), ela não serve — gere de novo reforçando essa direção no prompt.
...
One single wide image containing THREE separate full-body character sprites standing side by side, evenly spaced with generous empty gaps between each one so they can be cropped apart later. All three at the same pixel scale and the same ground line, in a calm static idle pose — no motion blur, no action pose, no animation frames, just one clean standing pose each. CRITICAL: every single one of the three characters must be facing RIGHT — shown in right-facing profile or a 3/4 view turned toward the right side of the frame, as if all three are looking at/ready to move toward something standing to their right. None of them may face left, face forward, or face the viewer — this is a strict requirement, since in the game the player's hero always stands on the left side of the screen and must visually face the enemy on their right.
...
One single full-body character sprite, in a calm static idle pose — no motion blur, no action pose, no animation frames. CRITICAL: the character must be facing RIGHT — shown in right-facing profile or a 3/4 view turned toward the right side of the frame. It may NOT face left, face forward, or face the viewer — this is a strict requirement, since in the game the player's hero always stands on the left side of the screen and must visually face the enemy on their right.
...
One single wide image containing FOUR separate full-body character sprites standing side by side, evenly spaced with generous empty gaps between each one so they can be cropped apart later. All four at the same pixel scale and the same ground line, in a calm static idle pose — no motion blur, no action pose, no animation frames. CRITICAL: every single one of the four characters must be facing RIGHT — shown in right-facing profile or a 3/4 view turned toward the right side of the frame, as if all four are looking at/ready to move toward something standing to their right. None of them may face left, face forward, or face the viewer — this is a strict requirement, since in the game the player's hero always stands on the left side of the screen and must visually face the enemy on their right.
...
One single wide image containing TWO separate full-body character sprites standing side by side, evenly spaced with a generous empty gap between them so they can be cropped apart later. Both at the same pixel scale and the same ground line, in a calm static idle pose — no motion blur, no action pose, no animation frames. CRITICAL: both characters must be facing RIGHT — shown in right-facing profile or a 3/4 view turned toward the right side of the frame, as if both are looking at/ready to move toward something standing to their right. Neither may face left, face forward, or face the viewer — this is a strict requirement, since in the game the player's hero always stands on the left side of the screen and must visually face the enemy on their right.
