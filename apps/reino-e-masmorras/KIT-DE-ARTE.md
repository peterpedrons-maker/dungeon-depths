...
> Substitui o prompt antigo — a classe foi redesenhada depois que esse prompt foi escrito e a arte já entregue (`feiticeiro.webp`) ficou obsoleta: nem as trilhas ("Explosão Arcana"/"Sobrecarga Mística"/"Domínio Arcano") nem nenhum dos 15 nomes de habilidade batem com a árvore real de hoje (Ruptura/Reverberação/Moldagem). Reescrito do zero com os nomes e cores reais de `skills.ts`. Arma do Feiticeiro conferida contra `weapon-feiticeiro.webp`: é grimório/livro de magia em todas as 10 variações — como nenhum dos 15 nomes reais de habilidade descreve um golpe físico de arma (são todos efeitos de magia pura), o grimório não precisa aparecer desenhado no ícone; nenhum ícone abaixo pede uma arma física. Upgradado pra convenção de medalhão circular e pra regra de especificidade (peça exata + limite exato do efeito) — arte anterior nunca foi gerada nesse padrão.
>
> **v2 (feedback do usuário):** a primeira versão parecia flecha mágica genérica (quase todo ícone era um "bolt" voando com rastro). Trocado por cristal rachando/onda de ressonância/runa geométrica — mas o usuário achou essa segunda versão **pior ainda**: virou diagrama técnico estático (glifo parado, anéis concêntricos tipo esquema, agulha de bússola) em vez de parecer arte de habilidade de jogo de verdade. Pedido explícito: pensar em como são os ícones de habilidade de jogos consagrados do gênero (MOBA/MMORPG) — sempre uma cena de ação dramática e legível de longe (mãos conjurando, uma explosão no auge, uma lâmina de luz cortando o ar), nunca um símbolo estático parado no centro. **v3 abaixo** — mesmos temas por trilha (cristal/eco/corte), mas cada ícone agora é uma cena de ação congelada no instante de pico (mãos canalizando, cristal estourando, lâmina cortando), com direção de arte explícita pedindo silhueta forte e legível e nada de diagrama/símbolo parado.

```
Hand-painted medieval fantasy game UI asset, rich digital painting style, icon set for a talent/ability tree — same painted style as the game's other UI icons (gold coin, health potion, ruby heart), NOT flat vector, NOT pixel art. Every icon must read the way a real, professionally-painted RPG/MOBA ability icon reads: a bold, dramatic, high-impact action caught at its single most striking instant, with a strong, instantly-readable silhouette that stays legible even shrunk down very small. NEVER a flat technical diagram, NEVER a calm static symbol or glyph just sitting motionless in the frame — always a scene of raw power happening right now (hands channeling force, an object erupting, a blade cutting through the air), rendered with dramatic directional lighting, deep shadow, and a bright glowing core light source.
...
IMPORTANT GLOBAL RULE: none of the fifteen icons below may depict a flying projectile, arrow, bolt, or dart of any kind — this class never fires anything at range. Every effect instead happens right in the medallion — a burst, a channel, a slash, a shatter — captured at its peak instant, with real dynamism and motion (cracks still spreading, shards still flying, light still spilling), never a tidy symbol resting calmly in place.

Row 1 ("Ruptura" path — every medallion's rim and inner glow painted in a violet-magenta, #a03fb8, theme: raw force cracking a crystal open): 1) "Impacto de Origem" — a pair of glowing spectral hands cupped tightly around one violet crystal orb, fresh hairline cracks just now spreading across its surface with light spilling out through the fissures. 2) "Compressão Violenta" — one violet crystal violently crushed inward by unseen force at this exact instant, deep jagged fissures erupting with blinding light, the crystal's shape visibly deforming under the pressure. 3) "Ruptura Gêmea" — two identical violet crystals shattering open at the same instant side by side, both radiating bright cracked light outward in mirrored symmetry. 4) "Ponto de Colapso" — a violent implosion caught mid-motion: broken violet crystal shards and jagged crack-lines still visibly being torn inward and sucked toward one blinding point of light at the center. 5) "Supernova Interior" — one massive violet crystal at the exact instant of catastrophic detonation, blazing shard fragments and rays of light bursting outward in every direction, filling nearly the whole medallion.

Row 2 ("Reverberação" path — every medallion's rim and inner glow painted in a warm gold, #c89a2e, theme: an echoing detonation of magical energy): 6) "Pulso Bifurcado" — one bright golden burst of magical energy exploding outward at this instant, with a second, fainter translucent echo-burst layered slightly behind and offset from it, like a double detonation caught in the same frame. 7) "Eco Instável" — one bright golden magical explosion at its peak, with a flickering, unstable echo-copy trailing just behind it, the echo's edges visibly crackling and distorting like static. 8) "Cascata Arcana" — three golden bursts of magical energy detonating in a cascading diagonal line across the medallion, each one smaller and fainter than the last, like a chain of explosions still unfolding. 9) "Recorrência" — one bright golden magical burst with a glowing hourglass shape caught inside it, visibly cracking as its sand reverses direction, time itself bending around the explosion. 10) "Sobrecarga Viva" — four small golden bursts of energy colliding violently together into one blinding overloaded core of light, crackling arcs of energy leaping wildly between them.

Row 3 ("Moldagem" path — every medallion's rim and inner glow painted in a burnt orange-red, #c1502e, theme: raw magic forcefully shaped and cut): 11) "Vetor Forçado" — a pair of glowing hands forcefully gripping and bending one taut beam of orange-red energy into a straight, rigid line, the beam glowing brightest exactly at the point of strain. 12) "Campo de Distorção" — a burst of orange-red magical energy at the exact instant of impact, a visible shockwave ring warping and bending outward from the point of impact like a physical blast wave. 13) "Corte de Realidade" — one blazing orange-red blade of pure light caught mid-slash across the medallion, leaving a glowing torn seam ripped open in space behind its cutting edge. 14) "Forma Impossível" — three jagged shards of orange-red light spiraling together in mid-air at this instant, locking into an unstable glowing geometric formation, crackling energy arcing wildly between them. 15) "Forma Absoluta" — one fully-formed, blinding orange-red construct of interlocked light-shards blazing at maximum power, tearing a jagged glowing rift open through the air around it at this exact instant.
...
> Mesma revisão v3 da folha de Ativas acima: nada de símbolo/glifo parado — cada ícone é uma cena de ação congelada no instante de pico (cristal recém-rachado, explosão detonando, runa em brasa), com direção de arte explícita pedindo silhueta forte e legível, nunca um diagrama técnico.

```
Hand-painted medieval fantasy game UI asset, rich digital painting style, icon set for a talent/ability tree — same painted style as the game's other UI icons (gold coin, health potion, ruby heart), NOT flat vector, NOT pixel art. Every icon must read the way a real, professionally-painted RPG/MOBA ability icon reads: a bold, dramatic, high-impact action caught at its single most striking instant, with a strong, instantly-readable silhouette that stays legible even shrunk down very small. NEVER a flat technical diagram, NEVER a calm static symbol or glyph just sitting motionless in the frame.

Each of the nine icons is a CIRCULAR MEDALLION (a coin-like RPG skill-icon badge, not a loose picture floating on the background): a dark, almost-black disc with a soft glow radiating from its center in that row's theme color, ringed by a thick ornamented metal border with small triangular points/teeth jutting outward around the rim, painted in that same row's theme color. Inside the disc, the action-scene fills about 65-70% of the disc's inner area — richly rendered with warm directional lighting from the upper-left and a bright specular highlight. NO text, name, number, or label anywhere on or under any medallion.
...
Row 1 ("Ruptura" path — every medallion's rim and inner glow painted in a violet-magenta, #a03fb8): 1) "Fratura Arcana" — one bright violet crystal shard, freshly cracked and glowing at its broken edge, with two smaller, dimmer cracked shard-fragments drifting close beside it, all three caught still hanging in the air. 2) "Rachadura Espontânea" — a single small point of violet impact bursting into one sharp jagged crack of light, caught at the exact instant the crack rips open. 3) "Depois da Explosão" — one glowing violet crystal shard, brilliant and intact along one half, crumbling into fading embers drifting off the other half — power still visibly persisting after the blast.

Row 2 ("Reverberação" path — every medallion's rim and inner glow painted in a warm gold, #c89a2e): 4) "Ressonância" — two golden magical bursts of different sizes detonating together from one shared point at this instant, one bright and one fainter, caught overlapping in the same frame. 5) "Segunda Onda" — one golden magical burst marked with a bright crit-starburst at its core, with a fainter, translucent echo-burst trailing just behind and offset from it, both still expanding. 6) "Perpetuum Arcano" — one golden magical burst so overloaded that bright droplet-like flares of light are visibly flying outward past its own edge, spilling beyond its own boundary.

Row 3 ("Moldagem" path — every medallion's rim and inner glow painted in a burnt orange-red, #c1502e): 7) "Controle Arcano" — one blazing orange-red angular rune-sigil (sharp straight-edged geometric shape) burning at full intensity, its edges throwing bright specular highlights like a brand searing the air. 8) "Correção Instantânea" — the same blazing orange-red rune-sigil from icon 7, with one small bright arc of light snapping backward around it at this instant, correcting its course mid-burn. 9) "Lei Pessoal" — one unbroken loop of orange-red light caught mid-motion, its glowing trailing edge curving fully around and burning back into its own point of origin.
