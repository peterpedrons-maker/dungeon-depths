...
> Mesmo método v5 da folha de Ativas acima e do Feiticeiro: **nenhum ícone mostra o bruxo nem o grimório** — só o efeito mágico puro, sempre num estado mais contido/latente/permanente (marca gravada, token empilhado, cicatriz em repouso) em vez do momento explosivo de auge das Ativas, reforçando que passiva é um bônus constante.
...
Row 1 ("Nome Proibido" path — every medallion's rim and inner glow painted in a dark violet, #4a2a5a): 1) "Fragmentos do Nome" — three small jagged shard-fragments of glowing violet script/rune-text floating in a loose row; only the leftmost fragment glows steady violet, the other two are dim, unlit outlines waiting to activate. 2) "Primeira Letra" — a single drop of violet ink landing in dark space, caught at the exact instant it forms into one small glowing rune-fragment shard. 3) "Assinatura Falsa" — one glowing violet sigil with a single sharp diagonal line freshly struck through it, canceling and dimming exactly where the line crosses.

Row 2 ("Negociação" path — every medallion's rim and inner glow painted in a slate grey, #5b5f6a): 4) "Crédito Sombrio" — two small grey coin-like seal-tokens stacked one above the other, both glowing at matched steady brightness, floating quietly in dark space. 5) "Bom Pagador" — one grey coin-seal token pressing down and sealing shut a smaller dark violet debt-mark directly beneath it, a bright ring of light flaring at the point of contact. 6) "Advogado do Abismo" — three grey coin-seal tokens stacked in a tight column, all three lit evenly and steadily, a faint dark aura framing the whole stack.

Row 3 ("Transgressão" path — every medallion's rim and inner glow painted in a warm gold, #c89a2e): 7) "Estigmas" — three small gold scar-marks arranged in a loose row on a dark skin-like surface; only the leftmost scar glows warm gold, the other two are faint, pale, uncracked outlines waiting to activate. 8) "A Cicatriz Ensina" — one gold scar-mark glowing brighter than normal, a second, fainter ring of golden light pulsing steadily just outside its edge. 9) "Sem Volta" — three gold scar-marks fused closely together into one dense, overlapping cluster, all three fully lit and merged into a single continuous glow.
