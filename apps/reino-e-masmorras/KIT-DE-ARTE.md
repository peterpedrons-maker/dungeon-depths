...
Row 1 ("Ruptura" path — every medallion's rim and inner glow painted in a violet-magenta, #a03fb8): 1) "Impacto de Origem" — a single bolt of violet arcane energy shown mid-flight, a solid glowing violet orb with one short jagged streak trailing behind it; nothing else in frame. 2) "Compressão Violenta" — a single violet arcane bolt at the instant of impact against a small dark surface; exactly three short jagged crack-lines glow violet, radiating outward from the point of impact only, the rest of the surface staying plain unlit dark. 3) "Ruptura Gêmea" — two identical violet arcane bolts flying forward side by side in parallel, each trailing its own short jagged streak, nothing else in frame. 4) "Ponto de Colapso" — three glowing violet jagged crack-lines on a small dark surface, all bending inward and being pulled toward one bright violet point at the center; only the crack-lines and the center point glow, the rest of the surface stays plain unlit dark. 5) "Supernova Interior" — one massive violet explosion, jagged energy shards bursting outward in every direction from a single bright central point, filling most of the medallion.

Row 2 ("Reverberação" path — every medallion's rim and inner glow painted in a warm gold, #c89a2e): 6) "Pulso Bifurcado" — a single bright golden arcane bolt flying forward, with one smaller, translucent, dimmer duplicate golden bolt trailing behind and slightly offset to the side of it — the dim duplicate never overlaps or touches the bright main bolt. 7) "Eco Instável" — a single bright golden arcane bolt at the instant of impact, with one faint golden ripple-ring expanding outward from the impact point only, the rest of the frame staying dark and unlit. 8) "Cascata Arcana" — three bright golden arcane bolts flying forward in a diagonal line, each trailed by its own smaller, dimmer echo-duplicate offset behind it — three bolts, three dim echoes, none overlapping. 9) "Recorrência" — a single bright golden arcane bolt at the instant of impact, with one small golden hourglass shape floating beside the impact point, its sand visibly flowing upward against gravity to show it rewinding. 10) "Sobrecarga Viva" — four small bright golden arcane bolts converging together toward one central point just before impact, each trailed by its own smaller, dimmer echo-duplicate.

Row 3 ("Moldagem" path — every medallion's rim and inner glow painted in a burnt orange-red, #c1502e): 11) "Vetor Forçado" — a single orange-red arcane bolt flying forward along one thin glowing straight guide-line that points exactly in the bolt's direction of travel; only the bolt itself and this one guide-line glow, nothing else in frame. 12) "Campo de Distorção" — a single orange-red arcane bolt at the instant of impact, with one small rippling distortion-ring (rendered as 2-3 concentric warped orange-red lines, like heat-shimmer) expanding outward from the impact point only. 13) "Corte de Realidade" — a single orange-red arcane bolt shown mid-flight, having just sliced cleanly through one small translucent hexagonal barrier-shard; the barrier-shard is cracked open in a single straight line exactly along the bolt's path, the rest of the barrier-shard staying intact and translucent. 14) "Forma Impossível" — three orange-red arcane bolts flying forward in a sequence of three, evenly spaced; the first two are plain, the third (final, rearmost) bolt glows noticeably brighter and trails a sharper, longer streak than the other two. 15) "Forma Absoluta" — one large, extremely bright orange-red arcane blast at the instant of impact, tearing straight through the same translucent hexagonal barrier-shard as icon 13, now shattering into three glowing fragments flying outward from the point of impact only.
...
Row 2 ("Reverberação" path — every medallion's rim and inner glow painted in a warm gold, #c89a2e): 4) "Ressonância" — two concentric golden rune-rings of different sizes, both pulsing outward from one shared central point, the outer ring fainter than the inner one. 5) "Segunda Onda" — one bright golden arcane bolt marked with a small crit-starburst at its tip, trailed by one dimmer, smaller echo-duplicate bolt directly behind it — only the echo-duplicate is the focus, offset and never overlapping the bright original. 6) "Perpetuum Arcano" — one golden rune-circle with light visibly overflowing and spilling past its own ring's edge in a few small golden droplet-shapes, showing it exceeding its own boundary.
