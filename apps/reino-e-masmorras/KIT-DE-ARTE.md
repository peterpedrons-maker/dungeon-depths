...
>
> **Revisado após feedback do usuário:** a primeira versão descrevia quase todo ícone como um "bolt" (orbe/projétil) voando com um rastro atrás — visualmente indistinguível de flecha mágica genérica, e repetitivo entre os 15 ícones. Trocado por uma linguagem visual própria de cada trilha, sem nenhum projétil-tipo-flecha em lugar nenhum do sheet: Ruptura agora é sobre um **cristal rachando/comprimindo** (o "Pulso"/"Fraturas" da trilha viram tensão física acumulando e estourando), Reverberação é sobre **ondas de ressonância concêntricas** (tipo sino/gongo, refletindo "Eco"/"Ressonância"), e Moldagem é sobre **runas geométricas angulares e uma lâmina de luz cortando barreiras** (refletindo "Controle"/precisão/penetração). Cada trilha agora tem uma identidade visual clara e reconhecível à distância, nenhuma repetida.
...
IMPORTANT GLOBAL RULE: none of the fifteen icons below may depict a flying projectile, arrow, bolt, or dart of any kind — this class never fires anything. Every effect is either a self-contained crystal/fracture object, a ring/wave shape, or a static rune/geometric construct, always centered in place, never shown traveling or in flight.

Row 1 ("Ruptura" path — every medallion's rim and inner glow painted in a violet-magenta, #a03fb8, theme: a cracking, overloaded crystal): 1) "Impacto de Origem" — one small smooth violet crystal orb, faint hairline cracks just beginning to spread across its surface, glowing steadily from within. 2) "Compressão Violenta" — one fist-sized violet crystal under visible strain, deep jagged cracks running through its whole body, glowing brightest exactly along the crack-lines. 3) "Ruptura Gêmea" — two identical fist-sized violet crystals side by side, each cracked down its own center line, both glowing evenly from within their cracks. 4) "Ponto de Colapso" — a dense network of thin violet crack-lines arranged like a spiderweb, all bending and converging inward toward one single bright violet point at the exact center. 5) "Supernova Interior" — one large violet crystal caught at the exact instant of shattering, jagged broken shard-pieces flying outward from its shattered core in every direction, filling most of the medallion.

Row 2 ("Reverberação" path — every medallion's rim and inner glow painted in a warm gold, #c89a2e, theme: a struck bell sending out rings of sound): 6) "Pulso Bifurcado" — one small golden rune-glyph at the center, sending out exactly two concentric golden ripple-rings of different sizes expanding outward from the same central point, like a bell struck twice. 7) "Eco Instável" — one small golden rune-glyph at the center with one bright, perfectly round ripple-ring expanding from it, and a second, fainter ripple-ring just behind it whose edge is visibly wavering and uneven (not a perfect circle), showing instability. 8) "Cascata Arcana" — one small golden rune-glyph at the center with exactly three concentric golden ripple-rings nested one inside the other, each ring dimmer than the one before it, like a gong caught mid-resonance. 9) "Recorrência" — one small golden rune-glyph at the center with one ripple-ring frozen mid-expansion, and one small golden hourglass shape floating beside it, its sand visibly flowing upward against gravity to show time rewinding. 10) "Sobrecarga Viva" — four small golden rune-glyphs arranged in a tight cluster, each sending out its own ripple-ring simultaneously, all four rings overlapping into one bright zone of light at the shared center.

Row 3 ("Moldagem" path — every medallion's rim and inner glow painted in a burnt orange-red, #c1502e, theme: precise geometric runes and a cutting edge of light): 11) "Vetor Forçado" — one glowing orange-red rune shaped like a compass needle, snapped into perfect straight alignment, with a few short precise guide-lines radiating from its tip like a targeting reticle; the needle itself does not move or fly, it stands fixed and centered. 12) "Campo de Distorção" — a small circular zone of rippling, warped orange-red space (rendered as 3-4 concentric bent/wavy lines, like a heat-mirage lens) surrounding one small dark still point at the very center; nothing enters or exits the zone. 13) "Corte de Realidade" — one thin, perfectly straight blade-shaped edge of orange-red light standing upright at the center, having just sliced clean through one small translucent hexagonal barrier-panel positioned directly behind it; the barrier-panel is split open in one straight line exactly along the blade's edge. 14) "Forma Impossível" — three angular orange-red geometric rune-fragments (flat polygon shapes with sharp straight edges) arranged rotating into alignment around a shared center, the third and final fragment glowing noticeably brighter than the other two as it locks into place. 15) "Forma Absoluta" — one complete, fully-assembled orange-red geometric rune-construct (a complex angular mandala built from straight-edged polygon pieces, all locked together) blazing at full brightness at the center, with the same translucent hexagonal barrier-panel from icon 13 shattering into three glowing fragments around it.
...
Row 1 ("Ruptura" path — every medallion's rim and inner glow painted in a violet-magenta, #a03fb8): 1) "Fratura Arcana" — one bright violet jagged crack-line (like a single crack in glass) floating alone against dark shadow, with two shorter, fainter, barely-visible crack-lines sketched beside it representing the ability to hold up to three; only the one bright crack fully glows, the other two stay dim outlines. 2) "Rachadura Espontânea" — a single small point of violet impact with exactly one sharp jagged crack-line shooting outward from it, nothing else in the frame. 3) "Depois da Explosão" — a single violet crack-line that is bright and solid along the first half of its length nearest a central point, then fades to a faint dim outline for the second half, showing a fracture surviving at reduced strength.

Row 2 ("Reverberação" path — every medallion's rim and inner glow painted in a warm gold, #c89a2e): 4) "Ressonância" — two concentric golden rune-rings of different sizes, both pulsing outward from one shared central point, the outer ring fainter than the inner one. 5) "Segunda Onda" — one small golden rune-glyph at the center marked with a small crit-starburst directly above it, with one bright golden ripple-ring expanding from the glyph and one dimmer, smaller echo-ripple-ring just behind it — only the echo-ring is fainter, never overlapping the bright original ring. 6) "Perpetuum Arcano" — one golden rune-circle with light visibly overflowing and spilling past its own ring's edge in a few small golden droplet-shapes, showing it exceeding its own boundary.

Row 3 ("Moldagem" path — every medallion's rim and inner glow painted in a burnt orange-red, #c1502e): 7) "Controle Arcano" — one glowing orange-red angular rune symbol (a precise geometric compass-star shape, straight lines only, no curves) floating alone against dark shadow, its lines sharp and evenly lit. 8) "Correção Instantânea" — the same angular orange-red compass-star rune from icon 7, with one small curved arrow looping back around it counter-clockwise, representing a correction/rewind. 9) "Lei Pessoal" — a single orange-red circular arrow loop, its arrowhead curving all the way around and pointing back into its own tail, forming one closed unbroken ring.
